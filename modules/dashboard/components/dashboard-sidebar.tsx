...
export function DashboardSidebar({ initialPlaygroundData }: { initialPlaygroundData: PlaygroundData[] }) {
  ...
  // 1. REMOVED useState. Now the sidebar will update instantly when server data changes.
    ...
    <Sidebar variant="inset" collapsible="icon" className="border border-r">
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {/* 2. FIXED EMPTY STATE: Only checks starred playgrounds */}
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {/* 3. FIXED EMPTY STATE: Only checks recent playgrounds */}
